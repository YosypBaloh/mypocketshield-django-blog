...
def register(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(request, f'Felhasználó {username} sikeresen hozzáadva!')
...
def profile(request):
    if request.method == "POST":
        ...
        if profileForm.is_valid() and updateUserForm.is_valid():
            updateUserForm.save()
            profileForm.save()
            messages.success(request, f'Profiladatok sikeresen frissítve!')
